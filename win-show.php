...
<body>
    <div class="container">
        <div class="row">
            <div>
                <a style="margin: 30px 0 30px 0;  display:block; clear:both;" class="btn btn-primary" href="win-gallery.php"><- Gallery</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12" >
                <ul class="list-unstyled">
                    <?php
                        ...
                        $relativePath = "https://" . $_SERVER["SERVER_NAME"] . substr($_SERVER["SCRIPT_NAME"], 0,-12);
                        $dir  = $_GET['dir'];
                        if (isset($dir)){
                                        ...
                                        print(" <li class='media'>
                                                    ...
                                                    '<div class="media-body">
                                                        ...
                                                        <button style="margin-left: 0;" class="btn-copy" data-clipboard-target="#picture-url'. $i .'">
                                                            <img src="win-assets/clippy.svg" width="24" height="24" alt="Copy to clipboard">
                                                        </button>
                                                    </div>
                                                </li>
                                            <br>');
